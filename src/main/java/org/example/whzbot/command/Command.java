...
public enum Command {
    ...
    akn_common(CommandType.TAROT, Permission.ANYONE, "aknc"),
    akn_event(CommandType.TAROT, Permission.ANYONE, "akne"),
    akn_common10(CommandType.TAROT, Permission.ANYONE, "akncd"),
    akn_event10(CommandType.TAROT, Permission.ANYONE, "akned"),
    gs_event(CommandType.TAROT, Permission.ANYONE, "gse"),
    gs_weapon(CommandType.TAROT, Permission.ANYONE, "gsw"),
    gs_common(CommandType.TAROT, Permission.ANYONE, "gsc"),
    pcr_event(CommandType.TAROT, Permission.ANYONE, "pcre"),
